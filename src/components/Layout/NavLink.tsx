...
const NavLink: React.FC<NavLinkProps> = ({ to, title, isActive, isLoggedIn, handleUserClick }) => {
  return (
    <li className='list-none'>
      <Link
        to={to}
        className={`block py-2 px-3 text-black rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-colors-nba-blue md:p-1 dark:text-black md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent ${
