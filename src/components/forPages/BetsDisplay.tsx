...
const BetsDisplay: React.FC<BetsDisplayProps> = ({
  ...
  return (
    <div className="mt-4">
      <h4 className="text-lg font-semibold mb-2 text-center">Select the winner</h4>
            ...
            <div className="flex flex-col sm:flex-row w-full sm:w-2/3 justify-between gap-2 mt-2 sm:mt-0">
              ...
              <div className="relative w-full">
                ...
                >
                  ...
                  {isStartDatePassed &&
                    bet.currentStats[0] > bet.currentStats[1] + bet.differential && (
              ...
              <div className="relative w-full">
                ...
                >
                  ...
                  <p className="text-sm">
                    ...
                    <span className="ml-1 text-xs">(+{bet.differential})</span>
                  </p>
