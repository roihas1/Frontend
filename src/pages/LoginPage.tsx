...
const LoginPage: React.FC = () => {
  ...
  const { setIsLoggedIn, checkAuthStatus } = useAuth(); // Get from Context
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setRole(userRole);
      setIsLoggedIn(true);
      checkAuthStatus(); // Update global state
  ...
  return (
    <div className="relative flex items-center justify-center">
      ...
      {/* Login Form */}
      <AuthCard title="Beyond the Bracket" description="Welcome back! Please log in.">
