    ...
    <div className=" min-h-screen py-10 px-6 md:px-20 text-gray-800">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mt-16 flex justify-center">
          <div className="bg-white p-2 rounded-xl shadow text-center transform transition-transform duration-300 hover:scale-105 w-full max-w-md">
            ...
            <div className="flex justify-center gap-4 mt-4">
              <a
                href="https://www.linkedin.com/in/ido-alon-817275218/"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-blue-700 transition-colors duration-300"
              >
